              ...
              <div class="col-lg-6 align-self-center">
                <form id="contact" action="" method="get">
                  <div class="row">
                    ...
                    <div class="col-lg-12">
                      <ul>
                        <li><input type="checkbox" name="option1" value="cars"><span>Cars</span></input></li>
                        <li><input type="checkbox" name="option2" value="aparmtents"><span>Apartments</span></input></li>
                        <li><input type="checkbox" name="option3" value="shopping"><span>Shopping</span></input></li>
                        <li><input type="checkbox" name="option4" value="food"><span>Food &amp; Life</span></input></li>
                        <li><input type="checkbox" name="option5" value="traveling"><span>Traveling</span></input></li>
                      </ul>
                    </div>
                    <div class="col-lg-12">
                      <fieldset>
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="sub-footer">
            ...
            <br>
			Design: <a rel="nofollow" href="https://templatemo.com" title="CSS Templates">TemplateMo</a></br></p>
          </div>
        </div>
      </div>
    </div>
